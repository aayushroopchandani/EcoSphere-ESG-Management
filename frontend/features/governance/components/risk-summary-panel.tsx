...
export function RiskSummaryPanel({
  ...
  return (
    <>
      <section
        className={cn(
          "governance-panel relative overflow-hidden rounded-lg border border-slate-200/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-950/85",
          className,
        )}
      >
      ...
      <PolicyPdfViewer
        ...
        key={activeCitationKey ?? "risk-summary-pdf-viewer"}
